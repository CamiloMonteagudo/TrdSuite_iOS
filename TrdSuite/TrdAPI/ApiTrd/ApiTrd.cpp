...
//-----------------------------------------------------------------------------------------------------------------
void TDSetPath( HTRD hTrd, const CStringA& Path, int sw )
  {
...
//-----------------------------------------------------------------------------------------------------------------
bool TDOpen( HTRD hTrd, const CStringF& sSrc, const CStringF& sDes )
  {
...
bool TDOpen( HTRD hTrd, int iSrc, int iDes )
  {
  return TDOpen( hTrd, CLangIso::Name(iSrc), CLangIso::Name(iDes));
  }
