...
public:
	...
	CFindPhrasesInSentence(CTranslationUser *ptrTranslationUser=NULL,LPCORACION ptrSentence=NULL,CDict *ptrDic=NULL):CScanWordsInDictionary(ptrTranslationUser,ptrSentence,ptrDic)
		{}
...
public:
	...
	CFindBracketPhraseInSentence(CTranslationUser *ptrTranslationUser=NULL,LPCORACION ptrSentence=NULL,CDict *ptrDic=NULL):CFindPhrasesInSentence(ptrTranslationUser,ptrSentence,ptrDic)
		{
