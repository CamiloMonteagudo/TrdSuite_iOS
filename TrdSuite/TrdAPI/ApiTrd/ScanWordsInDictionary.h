...
public:
	...
	//   
	///////////////////////////////////
	CScanWordsInDictionary(CTranslationUser *ptrTranslationUser=NULL,LPCORACION ptrSentence=NULL,CDict *ptrDic = NULL,bool bInsertAllWord = false):CStepInSentenceWithXX(ptrTranslationUser,ptrSentence)
		{
