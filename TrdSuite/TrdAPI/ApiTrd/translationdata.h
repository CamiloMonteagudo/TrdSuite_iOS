...
{
private:
	CDict   		 *m_TranslationDict;			  // Diccionario principal de traducción
	CDictLoad		 *m_InterchangePattern;		  // Patrones de intercambio
	//CDict    		 *m_InterchangePattern;		  // Patrones de intercambio
...
public:
	...
	CTranslationData()
		{
		m_TranslationDict 		= new CDict("DirData_TranslationDict");
	...
	inline CDict *GetPtrTranslationDic()
