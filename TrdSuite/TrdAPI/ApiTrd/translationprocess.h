...
public:
  ...
  void SetTrdDir(const CStringA& sSrc, const CStringA& sDes)
    {
    m_TranslationData.SetIsoName(CLangIso::MakeName(sSrc,sDes));
    m_TranslationData.GetSourceLanguage().SetIsoName(sSrc);
    m_TranslationData.GetTargetLanguage().SetIsoName(sDes);
    }
