...
CString CVConjugate( HCONJ hConj, const CString& verboi, int modo, int tiempo, int persona, int numero, bool negado, bool compuesto );
CString CVConcordWords( HCONJ hConj, const CString& noun, int srcGen, int srcNum, int desGen, int desNum, int grado);
CString CVConcordWordsIndex( HCONJ hConj, const CString& noun, int srcGen, int srcNum, int desGen, int desNum, int grado, LPWORD decCount, WORD idx);
CString CVDeclineNoun( HCONJ hConj, const CString& noun, int gen, int num, int decl);
CString CVDeclineNounIndex( HCONJ hConj, const CString& noun, int gen, int num, int decl, LPWORD decCount, WORD idx);
CString CVDeclineAdjective( HCONJ hConj, const CString& adj, int gen, int num, int decl, int artic);
...
bool CVOpen( LPCSTR language);

bool CVClose( LPCSTR language );
...
void CVCloseUser(DWORD idxUser);

LPCSTR CVUserConjugaVerb( DWORD idxUser,
                                   LPCSTR language, LPCSTR verboi,Modo modo,
                                   Tiempo tiempo, Persona persona,
                                   Numero numero, bool negado, bool compuesto);

LPCSTR CVUserConcordWords( DWORD idxUser, LPCSTR language, LPCSTR noun, Genero genfuente, Numero numfuente, Genero gendestino, Numero numdestino, Grado adjgrado);
LPCSTR CVUserDeclineAdjective( DWORD idxUser, LPCSTR language, LPCSTR adj, Genero gen, Numero num, Declination decl, ArticleType artic);
LPCSTR CVUserDeclineNoun( DWORD idxUser, LPCSTR language, LPCSTR noun, Genero gen, Numero num, Declination decl);
LPCSTR CVUserAuxiliaryVerb( DWORD idxUser, LPCSTR language, LPCSTR verbo);
LPCSTR CVUserDeclineNounIndex( DWORD idxUser, LPCSTR language, LPCSTR noun, Genero gen, Numero num, Declination decl, LPWORD decCount, WORD idx);
LPCSTR CVUserConcordWordsIndex( DWORD idxUser, LPCSTR language, LPCSTR noun, Genero genfuente, Numero numfuente, Genero gendestino, Numero numdestino, Grado adjgrado, LPWORD decCount, WORD idx);
WORD   CVDataConjCount(LPCSTR language);
WORD   CVDataConjTime(LPCSTR language, WORD idx);
WORD   CVDataConjMood(LPCSTR language, WORD idx);
WORD   CVDataConjCompound(LPCSTR language, WORD idx);
LPVOID CVGetPtrDicRef(LPCSTR language, DicName name);
void   CVSetDataPath(LPCSTR dataPath);
LPCSTR CVGetDataPath();

//---------------------------------------------------------------------------

LPCSTR CVReflexivePronoun(LPCSTR language, Persona persona,Numero numero);
bool   CVReflexiveVerbRoot(LPCSTR language, LPCSTR RefVerb, LPCSTR RootVerb);
LPCSTR CVPersonalPronoun(LPCSTR language, Persona persona,Numero numero);
LPCSTR CVDataConjName(LPCSTR language, WORD idx);
LPCSTR CVConjugaVerb( LPCSTR language, LPCSTR verbo, Modo modo,
                               Tiempo tiempo, Persona persona,
                               Numero numero, bool negado,bool compuesto);
LPCSTR CVConcordWords( LPCSTR language, LPCSTR noun,
                                Genero genfuente, Numero numfuente,
                                Genero gendestino, Numero numdestino,
                                Grado adjgrado);
LPCSTR CVAuxiliaryVerb( LPCSTR language, LPCSTR verbo);
bool   CVSetCelda(LPCSTR language, int fila, int col,LPCSTR s,TableName tbname);
LPCSTR CVDeclineNoun( LPCSTR language, LPCSTR noun, Genero gen, Numero num, Declination decl);
LPCSTR CVDeclineAdjective( LPCSTR language, LPCSTR noun, Genero gen, Numero num, Declination decl, ArticleType artic);
LPCSTR CVConcordWordsIndex( LPCSTR language, LPCSTR noun,
                                     Genero genfuente, Numero numfuente,
                                     Genero gendestino, Numero numdestino,
                                     Grado adjgrado, LPWORD decCount, WORD idx);
LPCSTR CVDeclineNounIndex( LPCSTR language, LPCSTR noun, Genero gen, Numero num, Declination decl, LPWORD decCount, WORD idx);
void CVSetRegPath( LPCSTR RegPath );
bool CVGetCelda(LPCSTR language, int fila, int col, LPSTR sval, TableName tbname);
bool CVInsFila(LPCSTR language, int fila, LPCSTR namefila, TableName tbname);
bool CVAddFila(LPCSTR language, LPCSTR namefila, TableName tbname);
bool CVDelFila(LPCSTR language, int fila, TableName tbname);
bool CVInsCol(LPCSTR language, int col, LPCSTR namecol, LPCSTR s, TableName tbname);
bool CVAddCol(LPCSTR language, LPCSTR namecol, LPCSTR s, TableName tbname);
bool CVDelCol(LPCSTR language, int col, TableName tbname);
