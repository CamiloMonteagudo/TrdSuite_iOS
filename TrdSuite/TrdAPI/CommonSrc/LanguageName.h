...
static LPCFSTR IsoNames[] = {LF"Es", LF"En", LF"It", LF"De", LF"Fr", LF"Pt"};

#define NLANGS  (int)(sizeof(IsoNames)/sizeof(IsoNames[0]))

static LPCSTR FullNames[NLANGS][NLANGS]=	{
                                        {"Español" , "Inglés"  , "Italiano"   , "Alemán"  , "Francés"    , "Portugués"     },
                                        {"Spanish" , "English" , "Italian"    , "German"  , "French"     , "Portuguese"    },
                                        {"Spagnolo", "Inglese" , "Italiano"   , "Tedesco" , "Francese"   , "Portoghese"     },
                                        {"Spanisch", "Englisch", "Italienisch", "Deustch" , "Französisch", "Portugiesisch" },
                                        {"Espagnol", "Anglais" , "Italien"    , "Allemand", "Français"   , "Portugais"     },
                                        {"Espanhol", "Inglês"  , "Italiano"   , "Alemão"  , "Francês"    , "Português"     }
                                        };
